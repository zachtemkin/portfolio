...
wk2: Execute changes from previous review; Final review with leadership team.
...
![buildings](./zhu-yunxiao-7pPdT3QKudo-unsplash.jpg)
```this is an image```

![rocks](./victor-martin-HU-RjTPM-9k-unsplash.jpg)
```this is an image```
...
![street](./alan-w-7wW-98idweY-unsplash.jpg)
```this is an image```
