...
background:
  heading: "Background"
  text: >
    A top US bank wanted to build brand equity with small business owners. The bank wanted to develop a "Small Business Academy", that would provide financial education resources to help business owners succeed.
...
- Community sourced content across a variety of topics with a focus on Small Business Owners sharing their own stories
- Goal to create 3 pieces for launch
- Atomize (break into smaller parts) and portray on external platforms to build awareness

#### Foundational Content

- Core content across 8 knowledge areas, covering vast majority of small business owner educational needs
- Content will be curated across multiple various learning paths, i.e. lifecycle stage, foundational course, etc, to drive relevancy and engagement
- Smartly tagged to relate to each other and branch offhero content
...
- Live, recorded panel of small business owners with Moderator
- Live event exclusive to Small Business Forum members
- Discussion of 2-3 topics
- Video of session can be atomized and presented as video, audio, or text

---

##### Live Community Workshop

- SME facilitates a live workshop on a topic
- Material thought starters and structures to get at differentiated results for common problems
- Small business owners sharing perspectives over video
- Ability for live chat and deep-dive on topics
- One time group specific topics

---

##### Mastermind Groups

- Informal advisory board that builds trust and uses each other to grow
- Collective expertise pooled to help get to the next level
- Topics can be planned by participating business owners
- Ongoing meeting with same group every month, multiple groups

---

##### Ride-Along

- Follow one small business owner and their team for a few days to a week
- Highlight team culture and real-world examples
- Capture critical moments documentary style as well as one-on-one interviews
- Video can be cut into smaller segments

---

##### Video Diary Missions

- Small business owner records key day-to-day experiences and interactions using their phone
- Prompts provided to give direction and structure
- Bite-sized chunks like Instagram stories
- ideos can be released live and then edited together for future consumption
