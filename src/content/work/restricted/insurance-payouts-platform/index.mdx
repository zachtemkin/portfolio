...
background:
  heading: "Background"
  text: "Traditionally, insurance companies use checks, mailed through the postal service, to pay out claims. Compared to modern delivery methods, mailed checks are slow and inflexible. This product leverages Visa Direct and other Visa services to give users a variety of digital and traditional options for receiving their payments."
tags:
  - tag: "ux design"
  - tag: "visual design"
