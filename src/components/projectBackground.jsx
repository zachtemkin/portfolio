...
const ProjectBackground = (props) => {
  return (
    <section className='background-info'>
      <div className='row'>
        <h2 className='background-header desktop-col-4 mobile-col-12'>
          {props.backgroundHeading}
        </h2>
        <div className='background-text desktop-col-8 mobile-col-12'>
          {props.backgroundText}
        </div>
      </div>
      <div className='hero-image row'>
        <div className='image-container desktop-col-8 mobile-col-12'>
